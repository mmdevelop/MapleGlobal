...
public class PlayerLoggedInHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        c.announce(CharacterData.CharacterSetField(player));
         ...
         */
        c.announce(CWvsContext.BroadcastMsg.sendServerMessage(c.getChannelServer().getServerMessage()));
        ...
        try {
            ...
            c.announce(CWvsContext.FriendResult.getBuddyList(buddies));
            try {
        ...
        if (pendingBuddyRequest != null) {
            ...
            c.announce(CWvsContext.FriendResult.invite(pendingBuddyRequest.getId(), pendingBuddyRequest.getName()));
        }
