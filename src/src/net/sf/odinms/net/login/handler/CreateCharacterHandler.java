...
public class CreateCharacterHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (charok && MapleCharacterUtil.canCreateChar(name, c.getWorld())) {
            ...
            c.getSession().write(CLogin.CreateNewCharacterResult.addNewCharacter(newchar, charok));
        } else {
        }
