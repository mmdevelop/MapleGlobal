...
public class SkillFactory {
    ...
    private static MapleDataProvider datasource = MapleDataProviderFactory.getDataProvider(new File("wz" + "/Skill"));
    private static MapleData stringData = MapleDataProviderFactory.getDataProvider(new File("wz" + "/String")).getData("Skill.img");
