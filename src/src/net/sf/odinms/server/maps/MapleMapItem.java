...
public class MapleMapItem extends AbstractMapleMapObject {
    ...
    protected static final long PICKUP_DELAY = 30 * 1000;

    /** Creates a new instance of MapleMapItem */
    public MapleMapItem(IItem item, Point position, MapleMapObject dropper, MapleCharacter owner, boolean playerDropped) {
        setPosition(position);
        this.item = item;
        this.dropper = dropper;
        this.owner = owner;
        this.meso = 0;
        timestamp = playerDropped ? -1 : System.currentTimeMillis();
    }

    public MapleMapItem(int meso, int displayMeso, Point position, MapleMapObject dropper, MapleCharacter owner, boolean playerDropped) {
        setPosition(position);
        this.item = null;
        this.meso = meso;
    ...
    public boolean isPickupTimeElapsed()
    {
        return System.currentTimeMillis() - timestamp >= PICKUP_DELAY;
    }
