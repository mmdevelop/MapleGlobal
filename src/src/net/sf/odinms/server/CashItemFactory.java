...
public class CashItemFactory {
    ...
    private static MapleDataProvider data = MapleDataProviderFactory.getDataProvider(new File("wz" + "/Etc"));
    ...
    public static List<Integer> getPackageItems(int itemId) {
        ...
        MapleDataProvider dataProvider = MapleDataProviderFactory.getDataProvider(new File("wz/Etc"));
