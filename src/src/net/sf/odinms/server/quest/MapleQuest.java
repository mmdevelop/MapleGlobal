...
public class MapleQuest {
    ...
    private static MapleDataProvider questData; // = MapleDataProviderFactory.getDataProvider(new File("wz" + "/Quest"));
    ...
    public void forfeit(MapleCharacter c) {
        ...
        MapleQuestStatus oldStatus = c.getQuest(this);
        MapleQuestStatus newStatus = new MapleQuestStatus(this, MapleQuestStatus.Status.NOT_STARTED, null);
