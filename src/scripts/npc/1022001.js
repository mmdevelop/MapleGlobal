/**
	*Npc: Regular Cab (Perion)
	*ID: 1022001
	*Description: Perion Cab
	*Author: Straight Edgy, cleaned up by wackyracer
**/

var maps = Array(104000000, 101000000, 103000000, 100000000);
var prices = Array(1200, 1000, 800, 1000);
