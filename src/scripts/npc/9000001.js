...
function action(mode, type, selection)
{
	...
	else if (status == 3)
	{
		if (selection == 0)
		{
			cm.sendNext("All this time, there are no events going on! The GM's will be holding surprise GM Events throughout MapleGlobal's lifetime, so stay on your toes and make sure to participate in at least one of the events for great prizes!");
			cm.dispose();
		}
		else if (selection == 1)
		{
